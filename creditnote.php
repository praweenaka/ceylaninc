...
<section class="content">
        ...
        <form role="form" class="form-horizontal">
            <div class="box-body">
                <div class="form-group">
                    ...
                    <a onclick="NewWindow('creditnote_search.php', 'mywin', '800', '700', 'yes', 'center');" class="btn btn-info  ">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="date" placeholder="DATE" id="crndate" value="<?php echo date('Y-m-d')?>"  class="form-control   ">
                </div>
            </div>
            ...
            <div class="col-sm-2">
                <input type="text" placeholder="INVOICE NO" id="invno" disabled  class="form-control">
            </div>
            <div class="col-sm-1">
    ...
    <div class="form-group"> 
        ...
        <div class="col-sm-2">
            <input type="date" placeholder="INVOICE DATE" id="inv_date" disabled  class="form-control">
        </div> 
    </div>
