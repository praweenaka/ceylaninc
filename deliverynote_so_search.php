...
<head>
    ...
    <script language="JavaScript" src="js/deliverynote.js"></script> 
...
<body>
    ...
    <div id="filt_table" class="CSSTableGenerator container"> 
        <table id="testTable"  class="table table-bordered">
            ...
            $sql2 = "SELECT * FROM s_ordmas WHERE CANCELL='0'   and (FLAG='4' or FLAG='6' or FLAG='8') order by REFNO desc ";
            ...
            foreach ($conn->query($sql2) as $row) { 
               	...
               	echo "<tr  >             
                 <td onclick=\"custno1('" . $row['REFNO'] . "');\">" . $row['REFNO'] . "</a></td>
                  <td onclick=\"custno1('" . $row['REFNO'] . "');\">" . $row["SDATE"] . "</a></td>
                  <td onclick=\"custno1('" . $row['REFNO'] . "');\">" . $row["CUSCODE"] . "</a></td>
                  <td onclick=\"custno1('" . $row['REFNO'] . "');\">" . $row["CUSNAME"] . "</a></td>  
                  <td onclick=\"custno1('" . $row['REFNO'] . "');\">" . $row["TOTQTY"] . "</a></td>  
                     <td onclick=\"custno1('" . $row['REFNO'] . "');\">" . $row["TOTAMOUNT"] . "</a></td>  
                </tr>";
            }
            ?>
        </table> </div>
