  ...
  <table width="750px;" cellspacing="0" border="0">
    ...
    <table width="750px;" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td class="right">DELIVERY NO: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><a id="pdfid" onclick="createPDF();"> <?php echo $row['REFNO']; ?></a></u></td>  
        </tr>
        <tr>
            ...
            <td></td>
            <td></td>
            <td class="right">SALES ORDER &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['ORDNO']; ?> </td>
        </tr>
     
      <tr> <?php  
            if($row['CANCELL']=="1"){
                echo "<th class='center' style='color:red;' colspan='5'> <u><a id='imgid' onclick='createJPG();'>CANCELED DELIVERY NOTE </a></u></th>";
            }else{
                echo "<th class='center' colspan='5'><u><a id='imgid' onclick='createJPG();'> DELIVERY NOTE </a></u></th>";  
            }
            ?>
   ...
   function createJPG() {  
        $(document).ready(function () {
            ...
            $("#imgid").on('click', function () {
                ...
                $("#imgid").attr("download", "DELIVERYNOTE.png").attr("href", newData);
            });
        });
