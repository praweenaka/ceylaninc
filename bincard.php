        ...
        <form role="form" name ="form1" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="number" placeholder="Discount 1"  id="dis1" onkeyup="cal();" class="form-control input-sm ">
                    </div>
                    <div class="col-sm-2">
                        <input type="number"  placeholder="Discount 2"  id="dis2" onkeyup="cal();" class="form-control input-sm ">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <input type="button" onclick="search();" class="btn btn-primary " value="..." id="searchcost" name="searchcost">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" value="<?php echo $rowt['last_invdata']; ?>" disabled  onchange="load_item();" id="dtfrom" class="form-control input-sm dt">
                    </div>
                    <div class="col-sm-1">
