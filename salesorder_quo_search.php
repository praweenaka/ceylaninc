...
<head>
    ...
    <script language="JavaScript" src="js/salesorder.js"></script> 
...
<body>
    ...
    <div id="filt_table" class="CSSTableGenerator container"> 
        <table id="testTable"  class="table table-bordered">
            ...
            $sql2 = "SELECT * FROM s_quomas where CANCELL='0'  and FLAG='0'  order by REFNO desc ";
            ...
            foreach ($conn->query($sql2) as $row) { 
               	...
               	echo "<tr  >             
                 <td onclick=\"custno3('" . $row['REFNO'] . "');\">" . $row['REFNO'] . "</a></td>
                  <td onclick=\"custno3('" . $row['REFNO'] . "');\">" . $row["SDATE"] . "</a></td>
                  <td onclick=\"custno3('" . $row['REFNO'] . "');\">" . $row["CUSCODE"] . "</a></td>
                  <td onclick=\"custno3('" . $row['REFNO'] . "');\">" . $row["CUSNAME"] . "</a></td>  
                    <td onclick=\"custno3('" . $row['REFNO'] . "');\">" . $row["TOTAMOUNT"] . "</a></td> 
                </tr>";
            }
            ?>
        </table> </div>
