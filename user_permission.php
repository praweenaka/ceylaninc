        ...
        <form role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label" for="txt_usernm"></label>
                ...
                <label class="col-sm-1 " for="invno">All Permission</label>
            <div class="col-sm-1">   
                <input type="checkbox"  onclick="checkall();" name="checktik" id="checktik">    
            </div>
