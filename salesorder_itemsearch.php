...
<head>
    ...
    <title>Search Sakes Order Item</title>
...
<body>
    ...
    <div id="filt_table" class="CSSTableGenerator container"> 
        <table id="testTable"  class="table table-bordered">
            ...
            $sql2 = "SELECT * from s_mas where CANCELL='0' order by stk_no  desc";
            ...
            foreach ($conn->query($sql2) as $row) { 
                $cuscode = $row['STK_NO']; 
                echo "<tr>               
                <td onclick=\"custno1('$cuscode', '$stname');\">" . $row['STK_NO'] . "</a></td>
                <td onclick=\"custno1('$cuscode', '$stname');\">" . $row['DESCRIPT'] . "</a></td>
                <td onclick=\"custno1('$cuscode', '$stname');\">" . $row['BRAND_NAME'] . "</a></td>  
                </tr>";
            }
            ?>
        </table> </div>
