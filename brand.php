...
<section class="content">
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title"><b>Brand Master</b></h3>
		...
		<form name= "form1" role="form" class="form-horizontal">
			<div class="box-body">
				...
				<table class="table  " style="width:70%">
                  ...
                  <tbody>
                    <tr>
                      <th class="col-sm-2"><input type="text" placeholder="Brand Code" id="code" name="code" class="form-control  input-sm " ></th>
                      <td class="col-sm-5"><input type="text" placeholder="Brand Name" id="name" name="name" class="form-control  input-sm" ></td>
                      <td><input type="checkbox" placeholder="Activate" id="act" name="act" class=" input-sm" ></td> 
                    </tr>
