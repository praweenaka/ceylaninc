    ...
    <div class="box box-primary">
        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label" for="invno">Production No</label>
                    <div class="col-sm-2">
                        <input type="text" placeholder="Production No" disabled id="invno" class="form-control  input-sm">
                    </div>
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('production_search.php', 'mywin', '800', '700', 'yes', 'center');
                        return false" href="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                 ...
                 <label class="col-sm-2 control-label" for="invno">Sales Order No</label>
                    <div class="col-sm-2">
                        <input type="text" placeholder="Sales Order No" disabled id="ordno" class="form-control  input-sm">
                    </div>
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('production_so_search.php', 'mywin', '800', '700', 'yes', 'center');
                        return false" href="">
                        <input type="button" class="btn btn-primary" value="..." id="searchcust" name="searchcust">
                    </a>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select id="department" class="form-control input-sm" disabled >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                        <textarea name="txt_remarks" id="txt_remarks"  rows="2" class="form-control"></textarea>  
                    </div>  
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input type="text" placeholder="Total" disabled id="total_value" style="text-align:right;" class="form-control input-sm">
    </div>
</div>
 
<table class="table table-bordered"> 
<tr class='info'> 
        <th   >Purchase Item History</th>  
    </tr> 
    <tr class='info'>
        <th style="width: 120px;">Item</th>
        <th style="width: 340px;">Description</th> 
...
<div class="form-group">
    ...
    <label class="col-sm-1 control-label" for="txt_remarks">Total</label>
    <div class="col-sm-2">
        <input type="text" placeholder="Total" disabled id="total_value1" style="text-align:right;" class="form-control input-sm">
    </div>
</div>
<div class="form-group"></div>
</div>
