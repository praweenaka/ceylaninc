    ...
    <div class="box box-primary">
        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label" for="invno">Delivery  No</label>
                    <div class="col-sm-2">
                        <input type="text" placeholder="Delivery NO" disabled id="invno" class="form-control  input-sm">
                    </div>
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('deliverynote_search.php', 'mywin', '800', '700', 'yes', 'center');
                        return false" href="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   ...
                   <label class="col-sm-2 control-label" for="c_code">Sales Order</label>
                <div class="col-sm-2">
                    <input type="text" placeholder="Sales Order No" disabled="" name="ordno" id="ordno" class="form-control  input-sm">
                </div>
   <div class="col-sm-1"> 
                    <a onfocus="this.blur()" onclick="NewWindow('deliverynote_so_search.php', 'mywin', '800', '700', 'yes', 'center');
                    return false" href="">
                    <input type="button" class="btn btn-primary" value="..." id="searchcust" name="searchcust">
                     </a> 
                  </div>
...
<script src="js/deliverynote.js"></script>
<script>
    new_inv();
</script>
<?php
