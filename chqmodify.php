    ...
    <div class="box box-primary">
        ...
        <form role="form" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="CUSTOMER NAME" id="cusname" disabled=""  class="form-control">
                </div> 
                <div class="col-sm-1">
                    <a onfocus="this.blur()" onclick="NewWindow('chqmodify_cus_search.php', 'mywin', '800', '700', 'yes', 'center');
                    return false" href="">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" placeholder="CHEQUE NO" id="chkno" disabled  class="form-control">
            </div> 
            <div class="col-sm-1">
        ...
        <div class="form-group"> 
            ...
            <div class="col-sm-3">
                <input type="text" placeholder="BANK" id="bank" disabled   class="form-control">
            </div>
            <div class="style1" id="lblmodi" ></div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" placeholder="CHEQUE AMOUNT" id="chamount" disabled  class="form-control">
            </div>
        </div>
         <div class="form-group">
