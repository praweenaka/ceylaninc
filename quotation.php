...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label" for="invno">Quotation No</label>
                    <div class="col-sm-2">
                        <input type="text" placeholder="Quotation No" disabled id="invno" class="form-control  input-sm">
                    </div>
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('quotation_search.php', 'mywin', '800', '700', 'yes', 'center');
                        return false" href="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1"> 
                    <a onfocus="this.blur()" onclick="NewWindow('quotation_cus_search.php', 'mywin', '800', '700', 'yes', 'center');
                    return false" href="">
                    <input type="button" class="btn btn-primary" value="..." id="searchcust" name="searchcust">
                     </a> 
                  </div>
    ...
    <table class="table table-bordered" style="overflow-x:auto;">
        ...
        <tr>
            <td>
                <input type="text" placeholder="Item Code" disabled id="itemCode" class="form-control input-sm">
            </td>
            <td>
                <input type="text" placeholder="Description" disabled id="itemDesc" class="form-control input-sm">
            </td>
            <td>
                <a href="" onclick="NewWindow('quotation_itemsearch.php', 'mywin', '800', '700', 'yes', 'center');
