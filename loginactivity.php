            ...
            <div class="box-body"> 
                ...
                <tbody>
                    ...
                    foreach ($conn->query($sql) as $row) {
                        ...
                        <tr>
                            <td> <?php echo $i?></td> 
                            <td onclick="name(this)"><?php echo $row['Name']; ?></td> 
                            <td onclick="name(this)"><?php echo $row['Date']; ?></td>   
                            <td onclick="name(this)"><?php echo $row['Logon_Time']; ?></td>   
                            <td onclick="name(this)"><?php echo $row['Logout_Time']; ?></td>   
                            <td onclick="name(this)"><?php echo $row['ip']; ?></td>     
