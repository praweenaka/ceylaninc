...
<body>
    ...
    <div id="filt_table" class="CSSTableGenerator container"> 
        <table id="testTable"  class="table table-bordered">
            ...
            $sql2 = "SELECT * FROM s_ordmas     order by REFNO desc ";
                ...
                // } 
                 ...
                 <td onclick=\"custno('" . $row['REFNO'] . "');\">" . $row['REFNO'] . "</a></td>
                  ...
                  <td onclick=\"custno('" . $row['REFNO'] . "');\">" . $row["CUSNAME"] . "</a></td> 
                     ...
                     <td onclick=\"custno('" . $row['REFNO'] . "');\">" . $row["TOTAMOUNT"] . "</a></td> 
                     <td onclick=\"custno('" . $row['REFNO'] . "');\">" . $row["QUONO"] . "</a></td> 
                </tr>";
            }
            ?>
        </table> </div>
